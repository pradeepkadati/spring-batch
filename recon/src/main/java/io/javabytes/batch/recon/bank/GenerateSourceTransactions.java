...
public class GenerateSourceTransactions {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < TARGET_RECORD_NUM; i++) {
            recordsToInsert.add(generateRecord(i,random, merchants));
        }
        ...
        for (BankTransaction transaction : recordsToInsert) {
            ...
            mongoTemplate.insert(transaction,"BankTransactions");
        }
    ...
    public static BankTransaction generateRecord(int i, Random random, String[] merchants) {
        ...
        return new BankTransaction(i, month, day, hour, minute, amount, merchant);
    }
